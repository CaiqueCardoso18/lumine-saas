...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-2xl border p-6 pr-8 shadow-lg transition-all',
  {
    variants: {
      variant: {
        default: 'border-lumine-lavender-pale bg-white text-lumine-charcoal',
        destructive: 'border-lumine-danger/20 bg-lumine-danger/10 text-lumine-danger',
        success: 'border-lumine-success/20 bg-lumine-success/10 text-lumine-success',
      },
    },
